...
public class BigramIndexing 
{
    public Set<String> readFile1(String str) throws IOException
    {
    ...
    //function for bigram 
    public static Set<String> ngram(int n, String[] str) 
    {
    ...
    public Set<String> readFile(String str) throws IOException
    {
        ...
        String[] arr1=str1.split(" ");
        String[] newarr1=remove(arr1);
        Set<String>res=ngram(2,newarr1);
        f.close();
        return res;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException,IOException
    {
        ...
        BigramIndexing ir=new BigramIndexing();
        ...
        Set<String>stockWord=ir.readFile1("C:\\Users\\hp\\OneDrive\\Desktop\\Document_List_IR\\stop_words.txt");
